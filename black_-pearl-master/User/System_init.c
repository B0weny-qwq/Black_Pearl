...
#include	"..\Code_boweny\Device\AutoDrive\autodrive.h"
#include	"..\Code_boweny\Device\Power\power_Adc.h"
...
void	UART_config(void)
{
	...
	COMx_InitStructure.UART_BaudRate  = LOG_UART_BAUDRATE;		//波特率, 一般 110 ~ 115200
