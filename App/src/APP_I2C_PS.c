/**
 * @file    APP_I2C_PS.c
 * @brief   I2C 轮询/自发自收示例实现
 * @author  STCAI / boweny
 * @date    2026-05-31
 *
 * @details
 * 本文件演示 I2C 从机与软件 I2C 主机配合的自发自收示例，并用数码管显示结果。
 * 当前 Black Pearl 工程不把该示例纳入主业务链路，仅保留为官方参考。
 *
 * @note 当前职责边界：
 * - 属于外设演示代码，不参与当前导航、无线或控制逻辑；
 * - 若重新启用，需要先确认不会与当前 I2C 传感器链路冲突。
 */
