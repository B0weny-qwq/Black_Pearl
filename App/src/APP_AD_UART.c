/**
 * @file    APP_AD_UART.c
 * @brief   ADC 转 UART 示例实现
 * @author  STCAI / boweny
 * @date    2026-05-31
 *
 * @details
 * 本文件演示多路 ADC 查询采样并经 UART 输出。当前 Black Pearl 工程默认不启用该示例，
 * 因为示例路径会占用与 GPS 相冲突的 UART/Timer 资源，不属于当前主链路。
 *
 * @note 当前职责边界：
 * - 仅作官方 ADC + 串口示例参考；
 * - 当前项目禁止直接恢复到 `APP_config()` 中启用，除非先调整 GPS 资源分配。
 */
