...
- 这份文档只描述上位机页面、串口连接和现场观察方法。
- 固件真实运行链、模块关系和协议边界以根目录 `README.md`、`doc/project_doc/total.md` 和各模块 `README.md` 为准。
- 如果页面字段含义与固件日志演进不一致，应优先同步这里和 `ship_log_viewer.html`，不要回头改旧兼容文档。
...
[viewer] Root: C:\...\Black_Pearl_v1.1
...
- 上位机主页面：
  [ship_log_viewer.html](/C:/Users/S/Desktop/STC_PROJECT/Black_Pearl_v1.1/tools/ship_log_viewer/ship_log_viewer.html)
- 根目录启动脚本：
  [start_ship_log_viewer.bat](/C:/Users/S/Desktop/STC_PROJECT/Black_Pearl_v1.1/start_ship_log_viewer.bat)
- 兼容跳转页：
  [doc/tools/ship_log_viewer.html](/C:/Users/S/Desktop/STC_PROJECT/Black_Pearl_v1.1/doc/tools/ship_log_viewer.html)
