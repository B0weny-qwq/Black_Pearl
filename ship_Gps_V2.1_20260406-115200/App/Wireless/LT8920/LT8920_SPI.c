...
unsigned char LT89xx_INIT(void)
{
  ...
  GPIO_InitTypeDef	GPIO_InitStructure;        
	GPIO_InitStructure.Pin  = GPIO_Pin_4|GPIO_Pin_5;//RXEN mosi
	GPIO_InitStructure.Mode = GPIO_OUT_PP;         
	GPIO_Inilize(GPIO_P3,&GPIO_InitStructure);
 
    GPIO_InitStructure.Pin  = GPIO_Pin_1|GPIO_Pin_0|GPIO_Pin_3;//sck cs TXEN
	GPIO_InitStructure.Mode = GPIO_OUT_PP;         
  ...
  while(checkTimes-- > 0)
  {
    ...
    {
      LT_WriteReg(LDT89xxconfig[CFG_CNT][0],LDT89xxconfig[CFG_CNT][1],LDT89xxconfig[CFG_CNT][2],LT8920_SEND);   //д�Ĵ�����Ϣ
