...
#define _LT8910drv_SPI_H__
    ...
    #define RF_CLK_H	P21 = 1
    #define RF_CLK_L	P21 = 0		
	
    #define RF_SS_SEND_H	P20 = 1
    #define RF_SS_SEND_L	P20 = 0	
		
	#define	RF_MISO_SEND 	P36	
		
#ifdef HW_V16
    #define RF_SS_REC_H		P20 = 1
    #define RF_SS_REC_L		P20 = 0	
	...
	#define TX_EN_H	    P23 = 1
    #define TX_EN_L	    P23 = 0
	
    #define RX_EN_H	    P34 = 1
    #define RX_EN_L	    P34 = 0

 //   #define RF_PKT		P32	

    #define SlowSPI_io	0	//1=LT8920??MCU??????   0=????SPI

    #define PKT_readReg	1 //PKT????????  0=?????????   1=??????????	// origin:0, modified on 2025-2-8
