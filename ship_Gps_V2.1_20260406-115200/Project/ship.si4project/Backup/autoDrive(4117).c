...
{	
	...
	if ((distance > 25) && (distance < 800))		// ¾àÀë´óÓÚ50Ã×  Ð¡ÓÚ600Ã×
	{	
		printf("autodrive active distance err!!  d=%u \r\n",distance);
		return TRUE;
	}
	return FALSE;
}
...
{	
    ...
    DcMotor_MLeft_PWM_Set(TRUE,speed);
    DcMotor_MRight_PWM_Set(TRUE,speed);
